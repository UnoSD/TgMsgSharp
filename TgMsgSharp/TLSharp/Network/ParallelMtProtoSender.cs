...
{
    public class ParallelMtProtoSender
    {
        //private ulong sessionId = GenerateRandomUlong();

        private ParallelTcpTransport _transport;
        private Session _session;

        public List<ulong> needConfirmation = new List<ulong>();

        public ParallelMtProtoSender(ParallelTcpTransport transport, Session session)
        {
            _transport = transport;
            _session = session;
        }

        public void ChangeTransport(ParallelTcpTransport transport)
        {
            _transport = transport;
        }
